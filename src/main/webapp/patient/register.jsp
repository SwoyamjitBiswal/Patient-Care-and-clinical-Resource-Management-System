...
<title>Patient Care System - Patient Registration</title>
<style>
...
<body>
                            ...
                            <form action="${pageContext.request.contextPath}/patient/auth?action=register" method="post" class="needs-validation" novalidate id="registrationForm">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="invalid-feedback">Please enter emergency contact number.</div>
                                    </div>
                                ...
                                <div class="text-center">
                                    <p class="mb-0">
                                        ...
                                        <a href="${pageContext.request.contextPath}/patient/login.jsp" class="auth-link">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            formatPhoneNumber(emergencyContactInput);
        });
    </script>
</body>
</html>
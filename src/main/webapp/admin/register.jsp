...
<title>Patient Care System - Admin Registration</title>
<style>
                ...
                <div class="col-12">
                    <div class="auth-card">
                        <div class="auth-header">
                            ...
                            <p class="mb-0">Create administrator account for system management</p>
                        </div>
                        <div class="auth-body">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/auth?action=register" method="post" class="needs-validation" novalidate id="registrationForm">
                                <div class="mb-4">
                                ...
                                <div class="text-center">
                                    <p class="mb-0">
                                        ...
                                        <a href="${pageContext.request.contextPath}/admin/login.jsp" class="auth-link">
